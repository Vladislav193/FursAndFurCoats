...
from myshop.shop.models.category_models import Product, Category
from myshop.shop.serializers.category_serializers import ProductSerializers, CategorySerializers
